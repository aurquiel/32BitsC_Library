...
#define ArraySet(array, data, sizeArray, typeData) _ArraySet(array, data, sizeArray, typeData, __FILE__, __FUNCTION__, __LINE__)
#define ArrayFind(array, data, sizeArray, typeData) _ArrayFind(array, data, sizeArray, typeData, __FILE__, __FUNCTION__, __LINE__)
...
#define ArrayFindNumberRepetitions(array, data, sizeArray, typeData) _ArrayFindNumberRepetitions(array, data, sizeArray, typeData, __FILE__, __FUNCTION__, __LINE__)
...
void _ArraySet(void* array, void *data, int64_t sizeArray, int8_t typeData, char const *fileName, char const *functionName, const int64_t lineNumber);
