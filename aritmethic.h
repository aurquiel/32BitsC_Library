...
#define AritmethicGetIndividualDigit(number, positionDigit, typeData) _AritmethicGetIndividualDigit(number, positionDigit, typeData, __FILE__, __LINE__, __FUNCTION__)
